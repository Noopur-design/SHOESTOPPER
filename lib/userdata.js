...
// On Vercel the working directory is read-only; /tmp is the only writable
// location (ephemeral — fine for a demo). Locally we use ./.data.
const DATA_DIR = process.env.VERCEL
  ? path.join(os.tmpdir(), "shoestopper-data")
